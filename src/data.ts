...
export const sourceText = `Production-Grade Prompting, Agents & Tool Use
...
export const quizItems: QuizItem[] = [
  {
    ...
    source: "Production-Grade Prompting, Agents & Tool Use - Prompting Craft"
  },
  {
    sentence: "Four techniques that give Claude a reliable output shape",
    translation: "Claude가 안정적인 출력 형태를 갖도록 해 주는 네 가지 기법",
    source: "Production-Grade Prompting, Agents & Tool Use - Prompting Craft"
  },
  {
